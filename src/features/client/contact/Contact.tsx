    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <details className="p-6 border rounded-xl shadow-sm">
        ...
        <p className="mt-3 text-gray-600">
          Sí, realizamos envíos a toda Lima Metropolitana con un costo adicional según la zona.
        </p>
      </details>
      ...
      <details className="p-6 border rounded-xl shadow-sm">
        ...
        <p className="mt-3 text-gray-600">
          Nuestro horario es de lunes a domingo, desde las 12:00 pm hasta las 11:00 pm.
        </p>
      </details>
      ...
      <details className="p-6 border rounded-xl shadow-sm">
        ...
        <p className="mt-3 text-gray-600">
          Sí, aceptamos todas las tarjetas de débito y crédito, además de pagos por Yape y Plin.
        </p>
      </details>
      ...
      <details className="p-6 border rounded-xl shadow-sm">
        ...
        <p className="mt-3 text-gray-600">
          No es obligatorio, pero recomendamos reservar en fines de semana y feriados para asegurar tu mesa.
        </p>
      </details>
      ...
      <details className="p-6 border rounded-xl shadow-sm">
        ...
        <p className="mt-3 text-gray-600">
          Sí, contamos con una variedad de platos vegetarianos y veganos en nuestro menú.
        </p>
      </details>
    </div>
  </section>
